 ...
 * @author FANNY BURGOS
 */
public class CrearArticulo extends javax.swing.JFrame implements ISuscripcionBuscarEnPUC,ISuscripcionBuscarEnAuxiliar{
    ...
    void Guardar(){
        ...
        int sw=0;
        if(service.IngresarArticulo(nombre, referencia, cantidadkg, auxingreso, auxactivo, auxcosto, tipo, categoria, preciounitario, porcentageiva/100,codigodebarras,auxiva,auxempaque)){
           this.Limpiar();           
            sw=1;
        }
