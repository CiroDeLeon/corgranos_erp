 ...
 * @author FANNY BURGOS
 */
public class CrearLiquidacionDePaddy extends javax.swing.JFrame implements ISuscripcionBuscarUsuario,ISuscripcionBuscarEnAuxiliar{
    ...
    public CrearLiquidacionDePaddy() {
        initComponents();        
    ...
    void Limpiar(){
        ...
        int ultimo=service.getDao().ObtenerNumeracion(lp.getTdocumento());
        this.jFormattedTextField1.setValue(new Integer(ultimo+1));
        u=null;
        ...
        this.jFormattedTextField6.setValue(new Double(8));
        ...
        this.jFormattedTextField25.setValue(new Double(0));
        this.jFormattedTextField21.setValue(new Double(0));        
    }
    void Guardar(){
        int tiquete=((Integer)this.jFormattedTextField23.getValue()).intValue();
        if(this.service.getPaddydao().ObtenerLiquidacion(tiquete)==null){
        if(this.aux!=null){    
        LiquidacionDePaddy lp=new LiquidacionDePaddy();
        int numeracion=service.getDao().ObtenerNumeracion(lp.getTdocumento());
        numeracion++;
        Usuario usuario=u;        
        Date FechaContable=this.dateChooserCombo1.getSelectedDate().getTime(); 
        String Resumen="Liquidacion de Paddy";
        String Creador=this.actor;
        ...
        double valor_descargue=((Double)this.jFormattedTextField25.getValue()).doubleValue();
        service.setAuxproveedor(aux);        
        if(service.GuardarLiquidacion(numeracion,usuario, FechaContable, Resumen, Creador, tiquete,
                bultos, humedad_pact, impureza_pact, rojo_pact, partido_pact, 
                yeso_pact, harina_pact, humedad_lab, impureza_lab, rojo_lab, partido_lab, 
                yeso_lab, harina_lab, pesobruto, pesodestarado, peso_liquidado, peso14_1,
                valor_kg, valor_liquidado, valor_compra, fomento, bolsa, retefuente, ajuste,
                total, polipropileno, registrabolsa,valor_descargue)){
           this.Limpiar();           
        }
        JOptionPane.showMessageDialog(this,service.ObtenerMensaje());
        }else{
        JOptionPane.showMessageDialog(this,"Debes Escoger Un Aux. Contable");    
        }
        }else{
            JOptionPane.showMessageDialog(this,"El Tiquete "+tiquete+" ya Existe");
        }
    }
    ...
    void Dibujar(LiquidacionDePaddy lp){
        ...
        this.jFormattedTextField20.setValue(new Double(lp.getBolsa()+lp.getRetefuente()));
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jFormattedTextField19, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jFormattedTextField23.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jFormattedTextField23FocusLost(evt);
            }
        });
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jFormattedTextField23, 0, 1, Short.MAX_VALUE)
                            .addComponent(jFormattedTextField14, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jFormattedTextField16, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel30.setText("Aux. Proveedores :");
        ...
        jLabel31.setText("VALOR DESCARGUE :");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jFormattedTextField25, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int op=JOptionPane.showConfirmDialog(this,"Esta Seguro de Guardar esta Liquidacion de Paddy");
        if(op==0){
        double valor=((Double)this.jFormattedTextField25.getValue()).doubleValue();
        if(valor>0){
           this.Guardar();
        }else{
           JOptionPane.showMessageDialog(this,"El valor del descargue es oblifgatorio");
        }
        }
    ...
    private void jFormattedTextField23FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jFormattedTextField23FocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_jFormattedTextField23FocusLost
    ...
    public void EventoDeSeleccionAuxiliar() {
        setCtaAuxiliar(ba.ObtenerAuxiliarSeleccionado());
        this.ba.dispose();
        this.show();
