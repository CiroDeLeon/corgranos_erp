...
import corgranos.Dominio.Servicios.Inventario.KardexPorMaquila;
 ...
 * @author FANNY BURGOS
 */
public class KardexPorMaquilaModel extends AbstractTableModel{
    private Vector <KardexPorMaquila> lista;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        KardexPorMaquila k=lista.get(rowIndex);
        switch(columnIndex){
    ...
    public void setLista(Vector <KardexPorMaquila> lista) {
        this.lista = lista;
    }
    public Vector <KardexPorMaquila> getLista(){
        return this.lista;
    }
    public KardexPorMaquila getRow(int rowIndex){
