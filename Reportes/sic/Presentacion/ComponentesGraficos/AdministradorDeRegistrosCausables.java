...
import sic.Presentacion.BuscarEnAuxiliar;
import sic.Presentacion.BuscarEnTablaDeRTF;
import sic.Presentacion.BuscarUsuario;
...
public class AdministradorDeRegistrosCausables extends javax.swing.JFrame implements ISuscripcionBuscarUsuario,ISuscripcionBuscarEnAuxiliar,ISuscripcionBuscarEnTablaDeRTF{
    ...
    public void GenerarRegistroDeCausacion(){        
        ...
        rc.setAux_rtf(rc.getItemtablartf().getIdauxiliar()+""+this.usuario.getId());
    ...
    void GuardarEnPUC(){
        ...
        if(cta==null){
           ...
           ps.IngresarEnElPUC(this.rc.getItemtablartf().getIdauxiliar()+""+this.usuario.getId(),usuario.getDescripcion(),aux.getTipoCta(),aux.isRequiereNit(),usuario,aux.isPublico(),aux.getCategoria());        
        }
    }
    public void ActualizarModelo(){      
        modelo=new RegistroDeCausacionModel(this.getUsuario().isAutoretenedor());
