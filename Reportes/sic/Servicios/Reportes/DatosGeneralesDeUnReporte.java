...
public class DatosGeneralesDeUnReporte {
    ...
    private DatosGeneralesDeUnReporte(){
    ...
    public static DatosGeneralesDeUnReporte ObtenerInstancia(){
        ...
        if(dr!=null){
           instancia.setDireccion("Direccion : "+dr.getDireccion());
           instancia.setTelefono("Telefonos : "+dr.getTelefono());
           instancia.setRazonsocial(dr.getRazonsocial());
           instancia.setNit("Nit/Cedula : "+dr.getNit()+" Regimen "+dr.getRegimen().toUpperCase());
        }
        return instancia;
    }
    /**
