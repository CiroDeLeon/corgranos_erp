...
public class RegistroDeCausacion {
    ...
    public Vector<Asiento> ObtenerAsientos(){
        ...
        a.setDetalle("");
        a.setDebito(0);
        a.setCredito(this.ObtenerValorRTF(debito,this.usuario.isAutoretenedor()));
        a.setEntradas(0);
        a.setSalidas(0);
        a.setNoFactura(0);
        a.setNoFacturaCompra(nofactura);       
        a.setBaseIVA(0);
        if(this.ObtenerValorRTF(debito,usuario.isAutoretenedor())==0){
        a.setBaseRTF(0);
        }else{
        a.setBaseRTF(debito);    
        }
    ...
    public Vector<Asiento> ObtenerAsientos(Object idAsientoDebito,Object idAsientoIva,Object idAsientoRTF){
        ...
        a.setNoFacturaCompra(nofactura);       
        a.setBaseIVA(0);
        if(this.ObtenerValorRTF(debito,this.usuario.isAutoretenedor())==0){
        a.setBaseRTF(0);
        }else{
        a.setBaseRTF(debito);    
        }
